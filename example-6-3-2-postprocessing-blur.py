...
class Example(Base):
    """
    Demostrar un efecto de desenfoque
    """
    def initialize(self):
        ...
        self.postprocessor.add_effect(HorizontalBlurEffect(blur_radius=3))
        self.postprocessor.add_effect(VerticalBlurEffect(blur_radius=3))
